...
copyright = '2017, people at FrimaStudio'
...
with open(version_file) as opened:
    for version_include in opened.readlines():
        version = version_include.split("=")[1].strip()
...
man_pages = [
    (master_doc, 'cookiecutter-fx', 'cookiecutter-fx Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'cookiecutter-fx', 'cookiecutter-fx Documentation',
   author, 'cookiecutter-fx', 'One line description of project.',
   'Miscellaneous'),
]
